                    ...
                    <div class="list_box">
                        <div class="list_items" >
                            ...
                            <div class="daily_list">
                                ...
                                <label class="checkbox chk-label-checked <?php echo isset($item["checked_at"]) ? "chk-label-checked" : "" ?>" for="chk_label<?php echo $item["no"];?>"><?php echo isset($item["checked_at"]) ? "✔" : "" ?></label>
                                <div class="list_title"><a href="./detail.php"><?php echo $item["content"]; ?></a></div>
                            </div>
                        </div>
                    </div>
                </div>
